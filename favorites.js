import{i as o}from"./assets/quote-DYA0pEf7.js";import"./assets/vendor-CK1Rzdhu.js";const l=document.querySelector(".favorites__list"),d=document.getElementById("favoritesButton");d.addEventListener("click",v());function v(){const t=JSON.parse(localStorage.getItem("exerciseData"));if(!(t==null||t.length===0)){l.innerHTML="";const s=t.map(({_id:a,name:n,burnedCalories:r,bodyPart:c,target:e})=>`
      ...
      </li>`).join("");l.insertAdjacentHTML("beforeend",s)}}document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector(".favorites__list"),s=".fav-filters__item-card",a=6,n=420,r=()=>{t.querySelectorAll(s).length>a?t.classList.add("scrollable"):t.classList.remove("scrollable")},c=()=>{t.querySelectorAll(s).length===1?t.style.width=`${n}px`:t.style.width="auto"},e=()=>{(window.innerWidth||document.documentElement.clientWidth)>=1440?c():t.style.width="auto"};r(),e(),new MutationObserver(i=>{r()}).observe(t,{childList:!0,subtree:!0}),new MutationObserver(i=>{e()}).observe(t,{childList:!0,subtree:!0}),window.addEventListener("resize",e)});
